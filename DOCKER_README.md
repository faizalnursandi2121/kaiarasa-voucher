...
services:
  kaiarasa:
    ...
    environment:
      ...
      - TZ=Asia/Jakarta
    volumes:
      - ./kaiarasa-data:/var/www/html/app/Database
```
...
3.  **Define Configuration (.env)**:
    ...
    *   **Crucial Step**: Edit `APP_PATH` to match your project path (usually `/www/dk_project/kaiarasa`).
...
5.  **Setup Reverse Proxy**:
    ...
    *   Enter your domain name (e.g., `kaiarasa.yourdomain.com`).
