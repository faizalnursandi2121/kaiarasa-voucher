...
<?php
$page_title_key = 'security.walled_garden.title';
    ...
    <div class="lg:col-span-2 space-y-4">
        ...
        <div class="page-toolbar">
            ...
            <div class="input-group md:w-64 z-10">
                ...
                <input type="text" id="global-search" class="form-input-search w-full" placeholder="Search host, ip, comment..." data-i18n="common.table.search_placeholder">
            </div>
            <!-- Dropdowns -->
            <div class="page-toolbar-right">
                <div class="w-44">
                    <select id="filter-action" class="custom-select form-filter" data-search="true">
...
<script>
    ...
    window.whenReady(() => {
        ...
        if (window.Kaiarasa && window.Kaiarasa.initFilterChips) {
            window.Kaiarasa.initFilterChips(['filter-action'], 'global-search');
        }
