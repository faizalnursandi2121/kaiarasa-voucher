...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex-grow w-full flex flex-col">
    ...
    <!-- ===== KPI Cards ===== -->
    <!-- ===== Topbar konten: search + notif + profile ===== -->
    <div class="sticky top-0 z-20 -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8 py-3 mb-2 bg-white/95 dark:bg-[#1a1c19] backdrop-blur border-b border-black/[.05] dark:border-white/[.05] flex items-center gap-3">
