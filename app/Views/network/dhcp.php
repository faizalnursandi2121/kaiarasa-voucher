...
$toolbar_html = '
    <div class="input-group md:w-64 z-10">
        ...
        <input type="text" id="global-search" class="form-input-search w-full" data-i18n-placeholder="common.table.search_placeholder" placeholder="Search mac, ip, host...">
    </div>
